...
export const Day = ({title, color, secondColor, icon, message, visible, onClick}) => {

    return (
        <div className={classes.dayContainer} style={{ backgroundColor: secondColor }} onClick={onClick}>
